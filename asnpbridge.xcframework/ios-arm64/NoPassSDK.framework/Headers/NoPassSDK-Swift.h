...
SWIFT_CLASS("_TtC9NoPassSDK18NoPassConfigurator")
@interface NoPassConfigurator : NSObject
+ (void)setSecretKey:(NSString * _Nonnull)key;
+ (void)setCurrentGPSCordinate:(double)latitude longitude:(double)longitude;
